...
## THIS SECTION INTRODUCES 77 OUTPUT ERRORS, WHEN ONLY "AGE ADULTS" AND "AGE KIDS" ARE ON
##        #################################
##        ## College graduation
##        #################################
##        ##try:
##        if hhSurvival == True:
##            popLi = self.fullPopDic[str(popLi[0])]
##            if int(popLi[4])==1:##If a student
##                if str(popLi[11])!="999999999":##If student years is actually a number
...
##                    if str(self.hhDic[str(popLi[10])])!="DEAD!":##If person is alive...
##                        try:
